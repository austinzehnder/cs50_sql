...
ordered from greatest number of public schools to least. If two cities have the same number of 
public schools, order them alphabetically
"""

SELECT "city", COUNT("id") AS "count" FROM "schools" WHERE "type" = 'Public School'
GROUP BY "city"
